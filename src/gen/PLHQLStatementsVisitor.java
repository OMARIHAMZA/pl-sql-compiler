...
public interface PLHQLStatementsVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PLHQLStatementsParser#increment_decrement_assignment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIncrement_decrement_assignment(PLHQLStatementsParser.Increment_decrement_assignmentContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PLHQLStatementsParser#bool_and}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBool_and(PLHQLStatementsParser.Bool_andContext ctx);
	/**
	 * Visit a parse tree produced by {@link PLHQLStatementsParser#bool_or}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBool_or(PLHQLStatementsParser.Bool_orContext ctx);
	/**
